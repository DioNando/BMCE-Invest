                ...
                <div class="p-6 bg-white border-b border-gray-200">
                    ...
                    <div class="mt-4 grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4">
                        ...
                        <div class="bg-purple-100 overflow-hidden shadow rounded-lg">
                            <div class="px-4 py-5 sm:p-6">
                                <dl>
                                    <dt class="text-sm font-medium text-gray-500 truncate">Créneaux horaires</dt>
                                    <dd class="mt-1 text-3xl font-semibold text-gray-900">{{ $stats['timeSlots'] }}</dd>
                                </dl>
                            </div>
                        </div>
                    ...
                    <h3 class="mt-8 text-lg font-medium text-gray-900">Créneaux horaires récents</h3>
                                ...
                                <div class="shadow overflow-hidden border-b border-gray-200 sm:rounded-lg">
                                    <table class="min-w-full divide-y divide-gray-200">
                                        ...
                                        <tbody class="bg-white divide-y divide-gray-200">
                                            @forelse ($recentTimeSlots as $timeSlot)
                                                <tr>
                                                    <td class="px-6 py-4 whitespace-nowrap">
                                                        <div class="text-sm text-gray-900">{{ $timeSlot->start_time->format('d/m/Y H:i') }}</div>
                                                        <div class="text-sm text-gray-500">{{ $timeSlot->end_time->diffInMinutes($timeSlot->start_time) }} min</div>
                                                    </td>
                    ...
                    <div class="mt-4 text-right">
                        <a href="#" class="inline-flex items-center px-4 py-2 border border-transparent text-sm font-medium rounded-md text-indigo-700 bg-indigo-100 hover:bg-indigo-200 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500">
                            Voir tous les créneaux horaires
                        </a>
                    </div>
                </div>
            </div>
